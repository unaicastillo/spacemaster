...
export class Asteroid{
    constructor(ctx,spritesheet,position={x:0,y:0},type=1){// constructor para la clase asteroide
        this.ctx = ctx;
    ...
    createAsteroid(){ //Crea un asteroide
    ...
    generatePosition(canvas){//genera la posicion
        let num = Math.floor(Math.random() * (4)) + 1;
        let x,y;
        switch(num){
            case 1:
